...
// La tua prima semplice modifica
...
//Per poter contribuire alle attività di documentazione, potreai modificare direttamente su GitHub che è il depositario dei nostri contenuti
...
{{% /notice %}}
//Hai bisogno di un https://github.com/join[Github user account^] per modificare le pagine sul sito the SuiteCRM.
//Se non ne hai ancora uno, ti sarà data la possibilité di crearne uno durante questo processo.
//{{% /notice %}}

=== 1. Navigate to the place you want to edit
// Naviga nel posto che vuoi modificare

Simply use your browser to go to the page you want to edit. You can use the menus 
and search feature to facilitate this.
//Basta utilizzare il browser per andare alla pagina che vuoi modificare. Puoi anche utilizzare il menu e il form di ricerca per facilitarti.

=== 2. Click to "Edit this page"
// Clicca su "modifica questa pagina"

Every page on the site has an "Edit this Page" link near the top.
// Ogni pagina sul sito ha un collegamento all'inizio della pagina "modifica questa pagina" 
